...
use frontend\components\UmengNotification;
use frontend\components\AndroidNotification;
use frontend\components\IOSNotification;
...
class UPush {
	...
	protected $validation_token = NULL;
        ...
        const ANDROID_APPKEY = "584e198b8f4a9d4b6c000ea0";
        const ANDROID_APPMASTERSECRET = "rhqapszngi0zzwtjb3gn3sxyruu1ssyn";

	function __construct() {
		$this->appkey = self::ANDROID_APPKEY;
		$this->appMasterSecret = self::ANDROID_APPMASTERSECRET;
	...
	function sendAndroidUnicast($device_tokens,$custom) {
		try {
	...
	function sendAndroidCustomizedcast($device_tokens) {
		try {
                    //
			...
			// use file_id to send customized notification.
                        $customizedcast->setPredefinedKeyValue("device_tokens",    $device_tokens); 
			...
			$customizedcast->setPredefinedKeyValue("after_open",       "go_app");
                        ...
                        $customizedcast->setPredefinedKeyValue("custom", "你好啊,哈哈哈哈");
